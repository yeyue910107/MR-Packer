	public static class Map extends  Mapper<Object, Text, Text, Text>{
		...
		public void setup(Context context) throws IOException, InterruptedException {
			...
			if (filename.compareTo("testquery8") == 0){
				filetag = 1;
			}
		}
		...
		public void map(Object key, Text value, Context context) throws IOException, InterruptedException{
			...
			if (filetag == 1){
				...
				context.write(new Text(""), new Text(1+"||"+Integer.parseInt(line_buf[1])));
			}
	...
	public int run(String[] args) throws Exception {
		...
		Job job = new Job(conf, "testquery7");
		job.setJarByClass(testquery7.class);
...
setMapperClass(Map.class);
	...
	public static void main(String[] args) throws Exception {
		...
		int res = ToolRunner.run(new Configuration(), new testquery7(), args);
		System.exit(res);
	}
